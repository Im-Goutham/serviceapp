                    ...
                    <View style={{flex:1,flexDirection:'row'}}>
                        ...
                        <View style={{flex:7,paddingHorizontal:scale(20)}}>
                            ...
                            <View style={{flex:1,flexDirection:'row',paddingVertical:scale(10)}}>
                                ...
                                <View style={{flexDirection:'row',justifyContent:'space-around',paddingHorizontal:scale(8)}}><Image source={require('../assets/icons/map_location_red.png')} style={styles.iconStyle}  resizeMode="contain" resizeMethod="resize"/><Text style={{fontFamily:'Montserrat-Regular',color:'#4A4A4A',marginLeft:8,marginRight:8}}>3 mi.</Text></View>
                            </View>
                            <View style={{flex:1}}>
