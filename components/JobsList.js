                                ...
                                <View style={{flexDirection:'column',marginTop:5}}>
                                    <View style={{flex:2}}>
                                        <Text style={{fontSize:12}}>
                                            <Icon style={{color:'#007FFA',fontSize:20, paddingR }} active name="ios-calendar-outline" />
                                            <Text style={{paddingLeft:5, fontFamily:"Montserrat-Medium",fontSize:16}}>Before the 19 Sep 2018</Text>
                                        </Text>
                                    </View>
                                    <View style={{flex:1, flexDirection:'row', justifyContent: 'space-between'}}>
                                        <Text style={{}}><Icon style={{color:'#c33c4c',fontSize:20}} active name="md-pin" /> <Text style={{paddingLeft:5, fontFamily:"Montserrat-Light"}}>3 km </Text></Text>
