                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: scale(20) }}>
                                     ...
                                     serviceProviders ? (
                                      serviceProviders.map((provider,key)=>{
                                              return  <View style={styles.categoryBox} key={key}>
                                                          ...
                                                          <Image source={provider.image ? provider.image : require('../images/name_placeholder.png')} style={[styles.img_placeholder,{borderRadius:scale(35),width:scale(70),height:70}]}/>
                                ...
                                <View style={styles.livetrackbox}>
                                    <TouchableOpacity style={{
                                        ...
                                        <TouchableOpacity style={{justifyContent: "center", alignItems: 'center',marginTop:scale(10)}}>
                                            <Text style={{
                                                fontSize: scale(13),
                                                color: "#3E85EF",
                                                fontFamily: "Montserrat-Medium"
                                    ...
                                    <TouchableOpacity style={{
                                        ...
                                        <TouchableOpacity 
                                             style={{justifyContent: "center", alignItems: 'center',marginTop:scale(10)}}
                                ...
                                <LinearGradient
                                    ...
                                    <TouchableOpacity
                                        ...
                                        <Text style={{fontFamily: "Montserrat-bold", fontSize: scale(16), color: "#fff"}}>MARK
                                            JOB AS COMPLETED</Text>
                                    </TouchableOpacity>
                                </LinearGradient>

                        <TouchableOpacity 
                           style={{ height:scale(54),alignItems:"center", justifyContent:"center", borderRadius:scale(27), backgroundColor:"#fff", marginBottom: scale(10) }}
                           onPress={()=>{this.props.navigation.navigate('giveRating')}}
                           >
                            <Text style={{ fontFamily: "Montserrat-bold", fontSize: scale(16), color: "rgb(212,213,214)" }}>RATE & REVIEW</Text>
                        </TouchableOpacity>
                       <View style={{flex:1,flexDirection:'row',paddingHorizontal:scale(10),paddingBottom:scale(30)}}>
                       <Image source={require('../assets/icons/report_flag.png')} style={[styles.pinimage,{height:scale(20)}]} resizeMode="contain" resizeMethod="resize" /><Text style={{marginLeft:scale(10),color:'#4A4A4A',fontFamily:'Montserrat-Medium'}}>Report Tewar. S</Text>
                       </View>
                    </View>
                </ScrollView>
         )
                        ...
                        <Header
                            ...
                            title={
                                <View style={{ justifyContent: 'center', alignItems: 'flex-start', width: "100%", height: scale(54) }}>
                                    <Text style={{ fontFamily: 'Montserrat-Bold', color: "#fff", fontSize: scale(18) }}>Need Cook</Text>
                                </View>
                            }
                            right={
                                <View style={{ backgroundColor: 'transparent', justifyContent: "center", alignItems: 'center', flexDirection: "row" }}>
