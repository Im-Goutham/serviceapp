...
import FindJobsScreen from '../FindJobsScreen';
...
describe('FindJobsScreen', () => {
    ...
    beforeEach(() => { 
    component = shallow(<FindJobsScreen store={store} onPress={mockFunc} navigation={navigation} />).dive();
    })
