  ...
  constructor(props) {
    ...
    focusNextField(id) {
     ...
     try {
        ...
        //    return error;
        //  });
       this.props.navigation.navigate('selectServiceProvider')
      ...
      return (  
        <View style={styles.container}>
           ...
           <View style={{justifyContent: "center" }}>
                ...
                <Button primary onPress={() => this.handleSubmit()} style={styles.loginButtom}><Text style={{color:'white'}}> Register </Text></Button>
                }
           </View>
           <TouchableHighlight  onPress={() => {this.props.navigation.navigate('login')}}><Text> Login </Text></TouchableHighlight>
